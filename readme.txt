...
Here's a link to [OpenAI](https://openai.com/ "OpenAI") and you can find all of the documatention here. If you need API key then goto [APIKEY](https://platform.openai.com/account/api-keys) and create an api key.
